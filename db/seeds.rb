...
fac4=Faculty.create(:name=>"Dr Andrea Kishne",:dept=>"Dept  of Soil and Crop Sciences Department", :email=>"akishne@ECE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"548A Heep Center", :phone_no=>"979-845-2541")
fac5=Faculty.create(:name=>"Dr Adrienne Brundage",:dept=>"Dept  of Entomology", :email=>"adrienne.brundage@AGNET.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"Heep Center Room 404A", :phone_no=>"979-845-9731")
fac6=Faculty.create(:name=>"Dr Sakhila Banu",:dept=>"Dept  of Veterinary Integrative Biosciences", :email=>"skbanu@cvm.tamu.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"Mailstop: 4458", :phone_no=>"(979) 458-3613") 
fac7=Faculty.create(:name=>"Dr Trez Jones",:dept=>"Dept  of Education & Human Development", :email=>"rtjones@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"560 Harrington Tower", :phone_no=>"(979) 845-2551")
fac8=Faculty.create(:name=>"Dr Christine Mark",:dept=>"Dept  of Education & Human Development", :email=>"cmark@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"559 Harrington Office Building", :phone_no=>"(979) 862-2935")
fac9=Faculty.create(:name=>"Dr Karen Smith",:dept=>"Dept  of Education & Human Development", :email=>"karen.smith@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac10=Faculty.create(:name=>"Dr Khalil Dirani",:dept=>"Dept  of Education & Human Development", :email=>"dirani@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac11=Faculty.create(:name=>"Dr M M Faruque Hasan",:dept=>"Dept  of Chemical Engineering", :email=>"hasan@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac12=Faculty.create(:name=>"Dr Jorge Seminario",:dept=>"Dept  of Chemical Engineering", :email=>"seminario@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"239 CHEN", :phone_no=>"9798453301") 
fac13=Faculty.create(:name=>"Dr Kelly Brumbelow", :dept=>"Water Resources Engineering and Asst Dept Head for Undergraudate Programs", :email=>"kbrumbelow@CIVIL.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac14=Faculty.create(:name=>"Dr Alireza Talebpour", :dept=>"Assistant Professor in Civil Engineering", :email=>"atalebpour@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac15=Faculty.create(:name=>"Dr Riccardo Bettati",:dept=>"Dept  of Computer Science and Engineering", :email=>"bettati@cse.tamu.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac16=Faculty.create(:name=>"Dr James Caverlee",:dept=>"Dept  of Computer Science and Engineering", :email=>"caverlee@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac17=Faculty.create(:name=>"Dr Dilma Da Silva", :dept=>"Department Head of Computer Science and Engineering", :email=>"dilma@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac18=Faculty.create(:name=>"Dr Walter Daugherity",:dept=>"Dept  of Computer Science & Engineering", :email=>"daugher@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac19=Faculty.create(:name=>"Dr Guofei Gu",:dept=>"Dept  of Computer Science and Engineering", :email=>"guofei@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac20=Faculty.create(:name=>"Dr Andreas Klappenecker",:dept=>"Dept  of Computer Science & Engineering", :email=>"klappi@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac21=Faculty.create(:name=>"Dr Hyunyoung Lee",:dept=>"Dept  of Computer Science & Engineering", :email=>"hlee@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac22=Faculty.create(:name=>"Dr Jyh-Charn (Steve) Liu", :dept=>"Professor Computer Science & Engineering", :email=>"liu@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac23=Faculty.create(:name=>"Dr Robin Murphy",:dept=>"Dept  of Computer Science & Engineering", :email=>"murphy@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac24=Faculty.create(:name=>"Dr Daniel Ragsdale",:dept=>"Dept  of Computer Science & Engineering", :email=>"rags@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac25=Faculty.create(:name=>"Dr Philip Ritchey",:dept=>"Dept  of Computer Science & Engineering", :email=>"ritchey@CSE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac26=Faculty.create(:name=>"Dr Joseph Boutros", :dept=>"Electrical & Comptuer Engineering", :email=>"joseph.boutros@QATAR.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac27=Faculty.create(:name=>"Dr Karen Butler-Purry",:dept=>"Dept  of Electrical and Computer Engineering", :email=>"klbutler@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac28=Faculty.create(:name=>"Dr Nick Duffield", :dept=>"Professor Electrical & Computer Engineering", :email=>"duffieldng@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac29=Faculty.create(:name=>"Dr Kamran Entesari",:dept=>"Dept  of Electrical & Computer Engineering, College of Engineering", :email=>"kentesar@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac30=Faculty.create(:name=>"Dr Costas N Georghiades", :dept=>"Electrical & Computer Engineering", :email=>"georghiades@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac31=Faculty.create(:name=>"Dr Jiang Hu",:dept=>"Dept  of Electrical & Computer Engineering", :email=>"jianghu@EXCHANGE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac32=Faculty.create(:name=>"Dr Mladen Kezunovic", :dept=>"Professor Electrical & Computer Engineering", :email=>"kezunov@ECE.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac33=Faculty.create(:name=>"Dr Laszlo B Kish",:dept=>"Dept  of Electrical & Computer Engineering", :email=>"laszlokish@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac34=Faculty.create(:name=>"Dr Christi K Madsen",:dept=>"Dept  of Electrical & Computer Engineering", :email=>"cmadsen@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac35=Faculty.create(:name=>"Dr Krishna Narayanan", :dept=>"Professor Electrical & Computer Engineering", :email=>"krn@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac36=Faculty.create(:name=>"Dr Narasimha Reddy",:dept=>"Dept  of Electrical and Computer Engineering", :email=>"reddy@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac37=Faculty.create(:name=>"Dr Srinivas Shakkottai",:dept=>"Dept  of Computer Engineering & Systems Group", :email=>"sshakkot@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac38=Faculty.create(:name=>"Dr Alex Sprintson",:dept=>"Dept  of Electrical & Computer Engineering", :email=>"spalex@ece.tamu.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac39=Faculty.create(:name=>"Dr Le Xie",:dept=>"Dept  of Electrical and Computer Engineering", :email=>"le.xie@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac40=Faculty.create(:name=>"Dr Ana Goulart",:dept=>"Engineering Technology & Industrial Distribution", :email=>"goulart@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac41=Faculty.create(:name=>"Mr Mark Johnson",:dept=>"Dept  of Engineering Technology & Industrial Distribution", :email=>"johnson78@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac42=Faculty.create(:name=>"Dr Ben Zoghi", :dept=>"Professor and Founding Director of RFID Oil & Gas Consortium", :email=>"zoghi@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac43=Faculty.create(:name=>"Dr Matthew Kane", :dept=>"Marine Engineering Technology", :email=>"kanem@TAMUG.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac44=Faculty.create(:name=>"Dr Luke Nyakiti", :dept=>"Assistant Professor", :email=>"nyakitil@TAMUG.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac45=Faculty.create(:name=>"Dr Pebjyoti Banerjee",:dept=>"Dept  of Mechanical Engineering", :email=>"dbanerjee@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac46=Faculty.create(:name=>"Dr Marvin L Adams", :dept=>"Heat Transfer Research Institute", :email=>"mladams@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac47=Faculty.create(:name=>"Dr Sunil Sunny Chirayath", :dept=>"Nuclear Security Science & Policy Institute", :email=>"sunilsc@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac48=Faculty.create(:name=>"Dr Pavel V Tsvetkov",:dept=>"Dept  of Nuclear Engineering", :email=>"tsvetkov@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac49=Faculty.create(:name=>"Dr Randy Kluver",:dept=>"Dept  of Communication", :email=>"rkluver@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac50=Faculty.create(:name=>"Dr Sandra Braman",:dept=>"Dept  of Communications", :email=>"braman@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac51=Faculty.create(:name=>"Mr Alexander Loutsenko",:dept=>"Dept  of English", :email=>"aloutsenko@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac52=Faculty.create(:name=>"Dr Gerianne Alexander", :dept=>"Associate Dean and Dept of Psychology", :email=>"galexander@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac53=Faculty.create(:name=>"Jason Whisenant", :dept=>"Director Legislative Programs", :email=>"jwhisenant@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac54=Faculty.create(:name=>"Dr Haipeng (Allan) Chen", :dept=>"Associate Professor in Mays Business School", :email=>"hchen@MAYS.TAMU.EDU", :desc=>"abc", :password=>"helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac55=Faculty.create(:name=>"Dr Ravi Sen", :dept=>"Associate Professor in Mays Business School", :email=>"rsen@MAYS.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac56=Faculty.create(:name=>"Dr Matthew Manley",:dept=>"Dept  of Information & Operations Management", :email=>"mmanley@MAYS.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac57=Faculty.create(:name=>"Dr Arun Sen",:dept=>"Dept  of Information & Operations Management", :email=>"arunsen.tx@gmail.com", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac58=Faculty.create(:name=>"Dr Dwayne Whitten",:dept=>"Dept  of Information & Operations Management", :email=>"dwhitten@MAYS.TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac59=Faculty.create(:name=>"Dr Jay Maddock", :dept=>"Dean, School of Public Health", :email=>"maddock@TAMHSC.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890") 
fac60=Faculty.create(:name=>"Robert E Brydia", :dept=>"Senior Research Scientist", :email=>"r-brydia@tti.tamu.EDU",:desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac61=Faculty.create(:name=>"Dr Mark W Burris", :dept=>"Associate Department Head for Research and Operations", :email=>"MBurris@TAMU.EDU",  :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"CE/TTI Building Room 301B", :phone_no=>"979-845-9875")
fac62=Faculty.create(:name=>"Sharon McCord", :dept=>"Research Development Specialist", :email=>"s-mccord@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"abcdefg", :phone_no=>"1234567890")
fac63=Faculty.create(:name=>"Christina Papke",:dept=>"Research Development Officer", :email=>"cpapke@TAMU.EDU", :desc=>"abc", :password=>" helloworld", :password_confirmation=>" helloworld", :office=>"Henderson Hall", :phone_no=>"9794581861")
