...
RSpec.describe EventsController, :type => :controller do
  ...
  describe 'NEW/UPDATE EVENT' do
    ...
    it "event should be new" do
      ...
      Event.stub(:new).and_return(@e1)
      get :new
      assigns(:event).should == @e1
    end
    ...
    it 'should call update_attributes and redirect' do
     ...
     it "does not save the new contact" do
       @e1 = FactoryGirl.create(:event)
      put :update, id: @e1, 
      event: FactoryGirl.attributes_for(:event, name: "")
      @e1.reload
      @e1.name.should eq("SSS")
  ...
  describe 'CREATE' do
    ...
    it "does not creates a new event" do
      expect{
        post :create, event: FactoryGirl.attributes_for(:event, name: "")
